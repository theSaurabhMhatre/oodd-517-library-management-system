...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { location: @library.location, max_days: @library.max_days, name: @library.name, overdue_fine: @library.overdue_fine } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { location: @library.location, max_days: @library.max_days, name: @library.name, overdue_fine: @library.overdue_fine } }
